...
DEFAULT_KRAKEN_EXE = "/oceanstor/scratch/tllseedorf/e1103389/kraken2/kraken/kraken2"
DEFAULT_THREADS    = 32
...
def pipeline(args):
    ...
    # 4) MARKERS: for each marker provided
    marker_map_list = []  # list of (marker_name, mapping_csv, subject_len_nt_dict)
    markers_dir = os.path.join(args.tmp_dir, "markers")
    markers=["mcrA=/oceanstor/scratch/tllseedorf/e1103389/hydrogenases/methanogen/mcrA.fasta",
    ...
    if markers:
        for item in markers:
            ...
            mapping_csv, subj_len_nt = run_marker_diamond(
                ...
                num_threads=args.kraken_threads
            )
