...
def main():
    ...
    args.add_argument('--hydrogenase_script_path', help='Enter the path to the hydrogenase script', 
                      default='/oceanstor/scratch/tllseedorf/e1103389/hydrogenases/hyDB/Diamond_blast_hyDB_reads.py')
...
if __name__=="__main__":
    ...
    eval_all_markers(r"/oceanstor/scratch/tllseedorf/e1103389/marker_sens_spec/test_reads",
                     marker_dir, neg_dir, max_reads=100,percent_junk=0.9,min_hyd_pidents=[10 ,20,50,70,90 ],min_hyd_qcovs=[0.1,0.2,0.3, 0.5,0.7,0.9,1],HPC=True,res_file=None)
    ...
    eval_all_hyds(r"/oceanstor/scratch/tllseedorf/e1103389/marker_sens_spec/test_reads",
                     marker_dir, neg_dir, max_reads=100,percent_junk=0.9,min_hyd_pidents=[20,50,70,90],min_hyd_qcovs=[0.5,0.7,0.9,1],HPC=True,res_file=None)
