...
def pipeline(reads_file,args):
    ...
    if "FINISHED" in open(output_filepath).read():
        return output_filepath
...
def main():
    ...
    for file in os.listdir(args.input_folder):
        ...
        if ext in["fasta","fa","fna","fastq","fq"]:
            ...
            #if output file already exist, skip
            if os.path.exists(os.path.join(args.output_folder,new_name)):
                continue
